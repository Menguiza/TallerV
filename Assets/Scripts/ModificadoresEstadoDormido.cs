...
public class ModificadoresEstadoDormido : MonoBehaviour
{
    ...
    IEnumerator ApplyDreamModifierOnNextFrame()
    {
        ...
        if (GameMaster.instance.Player.Pesadilla) GameMaster.instance.AddMod("Caos de pesadilla", 0, 20, 0, 0, 0, 0, 25, 0, 0, 0, 2f, 0);
        else GameMaster.instance.AddMod("Arte del soñador", 0, 10, 0, 0, 0, 0, 25, 0, 0, 0, 1f, 0);
